<template>
  <div class="my-header">
    ...
    <div class="header-logo" @click="goPage()">
      <MyIcon :icon="iconList.ERJI"></MyIcon>
      <span>{{ musicName }}</span>
    </div>
    <MyHeaderNav class="my-header-nav" :styleList="headerNavList" :activeName="activeNavName" @click="goPage"></MyHeaderNav>
    <!--search box-->
    <div class="header-search">
      <el-input placeholder="Search" :prefix-icon="Search" v-model="keywords" @keyup.enter="goSearch()" />
    </div>
    <!--Setting-->
    <MyHeaderNav v-if="!token" :styleList="signList" :activeName="activeNavName" @click="goPage"></MyHeaderNav>
...
import MyHeaderNav from "@/components/layouts/MyHeaderNav.vue";
...
export default defineComponent({
  ...
  setup() {
    ...
    const headerNavList = ref(HEADERNAVLIST); // Left navigation bar
    const signList = ref(SIGNLIST); // Right navigation bar
